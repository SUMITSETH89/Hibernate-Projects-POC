...
public class OneToOnePKDAOImpl implements IOneToOnePKDAO {
	...
	public void getDataByParent() {
		...
		Query<Student> query = sess.createNativeQuery("SELECT * FROM OTOPK_STUDENT", Student.class);
		//Send and Execute Query
		List<Student> stuList = query.list();
		//Process the Result
		stuList.forEach(student->{
		  System.out.println(student);
		  System.out.println("Proxy Class In the Form Associated Childs:: "+student.getLibraryDetails().getClass().getName());
		});
